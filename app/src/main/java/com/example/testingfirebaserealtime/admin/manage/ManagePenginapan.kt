...
import com.example.testingfirebaserealtime.databinding.ActivityManagePenginapanBinding
import com.example.testingfirebaserealtime.eksperimen.ListWisataAdapter
import com.google.firebase.auth.ktx.auth
import com.google.firebase.database.*
import com.google.firebase.ktx.Firebase

class ManagePenginapan : AppCompatActivity(), ListWisataAdapter.OnDeleteClickListener {

    private lateinit var binding: ActivityManagePenginapanBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityManagePenginapanBinding.inflate(layoutInflater)

        database = FirebaseDatabase.getInstance()
        myRef = FirebaseDatabase.getInstance().reference
        val penginapanRef = myRef.child("tempat").child("penginapan")

        adapter = ListWisataAdapter( this, tempatList)
        binding.recyclerView.layoutManager = LinearLayoutManager(this)
        binding.recyclerView.adapter = adapter

        penginapanRef.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                ...
                Log.w("Penginapan Activity", "Failed to read value.", error.toException())
            }
        })
    ...
    private fun deletePlaceByName(placeName: String) {
        ...
        val penginapanDatabase = ref.child("tempat").child("penginapan")
        ...
        deletePlaceFromDatabase(penginapanDatabase) { penginapanSuccess ->
            if (penginapanSuccess) {
                Toast.makeText(this, "Deleted from penginapan", Toast.LENGTH_SHORT).show()
                ...
                Log.e("DeletePlace", "Failed to delete place from penginapan")
                Toast.makeText(this, "Gagal menghapus data wisata dari penginapan", Toast.LENGTH_SHORT).show()
            }
        }
    }
}