...
import com.example.testingfirebaserealtime.databinding.ActivityManageSejarahBinding
import com.example.testingfirebaserealtime.eksperimen.ListWisataAdapter
import com.google.firebase.auth.ktx.auth
import com.google.firebase.database.*
import com.google.firebase.ktx.Firebase

class ManageSejarah : AppCompatActivity(), ListWisataAdapter.OnDeleteClickListener {

    private lateinit var binding: ActivityManageSejarahBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityManageSejarahBinding.inflate(layoutInflater)

        database = FirebaseDatabase.getInstance()
        myRef = FirebaseDatabase.getInstance().reference
        val sejarahRef = myRef.child("tempat").child("wisataSejarah")

        adapter = ListWisataAdapter( this, tempatList)
        binding.recyclerView.layoutManager = LinearLayoutManager(this)
        binding.recyclerView.adapter = adapter

        sejarahRef.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                ...
                Log.w("sejarahActivity", "Failed to read value.", error.toException())
            }
        })
    ...
    private fun deletePlaceByName(placeName: String) {
        ...
        val sejarahDatabase = ref.child("tempat").child("wisataSejarah")
        ...
        // Delete from sejarah
        deletePlaceFromDatabase(sejarahDatabase) { sejarahSuccess ->
            if (sejarahSuccess) {
                Toast.makeText(this, "Deleted from sejarah", Toast.LENGTH_SHORT).show()
                ...
                Log.e("DeletePlace", "Failed to delete place from sejarah")
                Toast.makeText(this, "Gagal menghapus data wisata dari sejarah", Toast.LENGTH_SHORT).show()
            }
        }
    }
}