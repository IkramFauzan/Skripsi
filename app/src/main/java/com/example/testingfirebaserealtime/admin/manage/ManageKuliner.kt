...
import com.example.testingfirebaserealtime.databinding.ActivityManageKulinerBinding
import com.example.testingfirebaserealtime.eksperimen.ListWisataAdapter
import com.google.firebase.auth.ktx.auth
import com.google.firebase.database.*
import com.google.firebase.ktx.Firebase

class ManageKuliner : AppCompatActivity(), ListWisataAdapter.OnDeleteClickListener {

    private lateinit var binding: ActivityManageKulinerBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityManageKulinerBinding.inflate(layoutInflater)
        ...
        kulinerRef.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                ...
                Log.w(KulinerActivity.TAG, "Failed to read value.", error.toException())
            }
        })
...
//        val kulinerDatabase = ref.child("tempat").child("kuliner")
//        val allPlaceDatabase = ref.child("semua")
//        val ratingDatabase = ref.child("rating")
//
//        Log.d("DeletePlace", "Place Name: $placeName")
...
//                }
//            } else {
//                Toast.makeText(this, "Wisata berhasil dihapus", Toast.LENGTH_SHORT).show()
//                Log.e("DeletePlace", "Failed to delete place from kuliner")
//            }
//        }
//    }
