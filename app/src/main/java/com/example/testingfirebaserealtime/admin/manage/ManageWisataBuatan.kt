...
import com.example.testingfirebaserealtime.databinding.ActivityManageBelanjaBinding
import com.example.testingfirebaserealtime.eksperimen.ListWisataAdapter
import com.google.firebase.auth.ktx.auth
import com.google.firebase.database.*
import com.google.firebase.ktx.Firebase

class ManageWisataBuatan : AppCompatActivity(), ListWisataAdapter.OnDeleteClickListener {

    private lateinit var binding: ActivityManageBelanjaBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityManageBelanjaBinding.inflate(layoutInflater)

        database = FirebaseDatabase.getInstance()
        myRef = FirebaseDatabase.getInstance().reference
        val belanjaRef = myRef.child("tempat").child("wisataBuatan")

        adapter = ListWisataAdapter( this, tempatList)
        binding.recyclerView.layoutManager = LinearLayoutManager(this)
        binding.recyclerView.adapter = adapter

        belanjaRef.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                ...
                Log.w("belanjaActivity", "Failed to read value.", error.toException())
            }
        })
    ...
    private fun deletePlaceByName(placeName: String) {
        ...
        val belanjaDatabase = ref.child("tempat").child("wisataBuatan")
        ...
        // Delete from belanja
        deletePlaceFromDatabase(belanjaDatabase) { belanjaSuccess ->
            if (belanjaSuccess) {
                Toast.makeText(this, "Deleted from belanja", Toast.LENGTH_SHORT).show()
                ...
                Log.e("DeletePlace", "Failed to delete place from belanja")
                Toast.makeText(this, "Gagal menghapus data wisata dari belanja", Toast.LENGTH_SHORT).show()
            }
        }
    }
}