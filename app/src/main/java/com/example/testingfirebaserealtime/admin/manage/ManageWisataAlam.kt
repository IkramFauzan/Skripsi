...
import com.example.testingfirebaserealtime.databinding.ActivityManageWisataBinding
import com.example.testingfirebaserealtime.eksperimen.ListWisataAdapter
import com.google.firebase.auth.ktx.auth
import com.google.firebase.database.*
import com.google.firebase.ktx.Firebase

class ManageWisataAlam : AppCompatActivity(), ListWisataAdapter.OnDeleteClickListener {

    private lateinit var binding: ActivityManageWisataBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityManageWisataBinding.inflate(layoutInflater)
        ...
        wisataRef.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                ...
                Log.w("wisataActivity", "Failed to read value.", error.toException())
            }
        })
    ...
    private fun deletePlaceByName(placeName: String) {
        ...
        val wisataDatabase = ref.child("tempat").child("wisataAlam")
        ...
        // Delete from wisata
        deletePlaceFromDatabase(wisataDatabase) { wisataSuccess ->
            if (wisataSuccess) {
                Toast.makeText(this, "Deleted from wisata", Toast.LENGTH_SHORT).show()
                ...
                Log.e("DeletePlace", "Failed to delete place from wisata")
                Toast.makeText(this, "Gagal menghapus data wisata dari wisata", Toast.LENGTH_SHORT).show()
            }
        }
    }
}