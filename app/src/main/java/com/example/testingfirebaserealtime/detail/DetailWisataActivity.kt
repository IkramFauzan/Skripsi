...
import com.example.testingfirebaserealtime.databinding.ActivityDetailWisataBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btn.setOnClickListener {
            ...
            if (message == 0f && review.isEmpty()) {
                Toast.makeText(this@DetailWisataActivity, "Rating dan komentar harus diisi", Toast.LENGTH_SHORT).show()
                return@setOnClickListener
            }

            if (message == 0f) {
                Toast.makeText(this@DetailWisataActivity, "Anda harus memilih rating sebelum memberi komentar", Toast.LENGTH_SHORT).show()
                return@setOnClickListener
            }

            if (review.isEmpty()) {
                Toast.makeText(this@DetailWisataActivity, "Anda harus mengisi field sebelum memberi komentar", Toast.LENGTH_SHORT).show()
                return@setOnClickListener
            }
            ...
            if (firebaseUser != null) {
                            ...
                            ratingRef.setValue(ulasan)
                                .addOnCompleteListener { task ->
                                    if (task.isSuccessful) {
                                        Toast.makeText(this@DetailWisataActivity, "Rating added successfully!", Toast.LENGTH_SHORT).show()
                                    } else {
                                        Toast.makeText(this@DetailWisataActivity, "Failed to add rating!", Toast.LENGTH_SHORT).show()
                                    }
                                }
                        } else {
                            Toast.makeText(this@DetailWisataActivity, "User data not found!", Toast.LENGTH_SHORT).show()
                        }
                    }

                    override fun onCancelled(error: DatabaseError) {
                        Toast.makeText(this@DetailWisataActivity, "Failed to fetch user data: ${error.message}", Toast.LENGTH_SHORT).show()
                    }
                })
            } else {
                ...
                alertBuilder.setPositiveButton("OK") {dialog, which ->
                    val intent = Intent(this@DetailWisataActivity, SignActivity::class.java)
...
//
                            ...
                            override fun onCancelled(error: DatabaseError) {
                                Toast.makeText(this@DetailWisataActivity, "Gagal memeriksa tempat favorit: ${error.message}", Toast.LENGTH_SHORT).show()
                            }
                        })
                    } else {
                        Toast.makeText(this@DetailWisataActivity, "Informasi pengguna tidak ditemukan", Toast.LENGTH_SHORT).show()
                    }

                }

                override fun onCancelled(error: DatabaseError) {
                    Toast.makeText(this@DetailWisataActivity, "Gagal mengambil informasi pengguna: ${error.message}", Toast.LENGTH_SHORT).show()
                }
            })
        } else {
            Toast.makeText(this@DetailWisataActivity, "Informasi tempat tidak lengkap", Toast.LENGTH_SHORT).show()
        }
