...
import com.example.testingfirebaserealtime.databinding.ActivityBelanjaBinding
import com.google.firebase.database.*

class WisataBuatanActivity : AppCompatActivity() {

    private lateinit var binding: ActivityBelanjaBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityBelanjaBinding.inflate(layoutInflater)

        database = FirebaseDatabase.getInstance()
        //myRef = database.getReference("penginapan")
        myRef = FirebaseDatabase.getInstance().reference
        val hotelRef = myRef.child("tempat").child("wisataBuatan")
